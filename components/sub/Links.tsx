            ...
            <ul className="ml-1 mt-8 flex items-center">
                <li className="mr-8 text-xs">
                    <a
                        ...
                        id="Github link"
                    >
                        <Github01Icon className="text-slate-400 hover:text-slate-200 h-7 w-7" />
                    </a>
                </li>
                <li className="mr-8 text-xs">
                    <a
                        ...
                        id="Linkedin link"
                    >
                        <Linkedin01Icon className="text-slate-400 hover:text-slate-200 h-7 w-7" />
                    </a>
                </li>
                <li className="mr-8 text-xs">
                    <a
                        ...
                        id="Twitter/X link"
                    >
                        <NewTwitterIcon className="text-slate-400 hover:text-slate-200 h-7 w-7" />
                    </a>
                </li>
                <li>
                    <a
                        ...
                        id="Email link"
                    >
                        <Mail01Icon className="text-slate-400 hover:text-slate-200 h-7 w-7" />
                    </a>
                </li>
            </ul>
        </div>
